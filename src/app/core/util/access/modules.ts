...
export const MODULES: { [key in MODULES_NAME]: IModules } = {
  ...
  [MODULES_NAME.ULB_SIGNUP_REQUEST]: {
    ...
    access: {
      [ACTIONS.VIEW]: [USER_TYPE.STATE, USER_TYPE.PARTNER, USER_TYPE.MoHUA, USER_TYPE.ADMIN],
      [ACTIONS.APPROVE]: [USER_TYPE.STATE, USER_TYPE.PARTNER, USER_TYPE.MoHUA, USER_TYPE.ADMIN],
      [ACTIONS.REJECT]: [USER_TYPE.STATE, USER_TYPE.PARTNER, USER_TYPE.MoHUA, USER_TYPE.ADMIN],
  ...
  [MODULES_NAME.STATE_AND_ULB_TYPE_WISE_REPORT]: {
    name: MODULES_NAME.OVERALL_REPORT,
    access: {
      [ACTIONS.VIEW]: [USER_TYPE.ADMIN, USER_TYPE.MoHUA, USER_TYPE.PARTNER, USER_TYPE.STATE],
    },
  },
  ...
  [MODULES_NAME.STATE_PROPERTY_TAX_QUESTIONNAIRE]: {
    ...
    access: {
      [ACTIONS.FORM_FILL]: [USER_TYPE.STATE, USER_TYPE.PARTNER, USER_TYPE.MoHUA, USER_TYPE.ADMIN],
      [ACTIONS.VIEW]: [USER_TYPE.STATE, USER_TYPE.PARTNER, USER_TYPE.MoHUA, USER_TYPE.ADMIN],
    },
  },
