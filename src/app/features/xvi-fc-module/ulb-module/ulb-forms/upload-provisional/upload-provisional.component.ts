...
@Component({
  selector: 'app-upload-provisional',
  standalone: true,
  imports: [NgClass, MatButtonModule, MatIconModule, MatProgressBarModule],
  templateUrl: './upload-provisional.component.html',
  styleUrl: './upload-provisional.component.scss',
})
export class UploadProvisionalComponent {
